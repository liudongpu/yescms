...
public class CommentAdd extends
	...
	public CommentAddResult Process(CommentAddInput inputParam,
		...
		DbUp.upTable("mc_user_comment").insert("member_code", getUserCode(),
				...
				FormatHelper.upDateTime(), "note",
				EncodeHelper.htmlEncode(inputParam.getNote()), "member_name",
				getOauthInfo().getLoginName(), "info_uid",
