...
<div class="ycsite_sl_box ycbase_body_back_layout" >
	<div class="c_box" >
		...
		<div class="c_desc">时间：${a_info["time"]}       <span  class="yctop_price">成交总金额：${a_info["success_price"]}</span></div>
		<div class="w_h_30"></div>
		<div class="c_aucimg"><@m_web_html_img p_img=a_info["file_url"] /> </div>
		<div class="w_h_30"></div>
	</div>
	<div class="c_line" >
	</div>
	<div class="c_box" >
		<#list a_list as el>	
			...
			<div class="c_item c_line">
				...
				<div class="c_left">
					<@m_web_html_img p_img=el["file_url"]  p_link="good_list?u_id="+el["uid"]/> 
				</div>
				<div class="c_right">
					<div class="c_title"><@m_web_html_href "good_list?u_id="+el["uid"] el["name"]/></div>
					<div class="w_h_20"></div>
					<div class="c_fix">时间：${el["time"]}</div>
					<div class="c_fix">成交总金额：<span  class="yctop_price">${el["success_price"]}</span></div>
				</div>
				<div class="w_clear w_h_30"></div>
			</div>
